  ...
  if (!guide) {
    return (
      <div className="container py-16 text-center pb-mobile-nav">
        ...
        <Link href="/guides" className="mt-4 inline-block text-accent hover:underline">← Back to guides</Link>
      </div>
    );
  }
  ...
  return (
    <div className="pb-mobile-nav">
      ...
      <div className="container pt-6 pb-12">
        {/* Breadcrumb */}
        <Link href="/guides" className="inline-flex items-center gap-1 text-label text-muted-foreground hover:text-foreground transition-colors mb-4">
