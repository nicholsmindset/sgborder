  ...
  if (!route) {
    return (
      <div className="container py-16 text-center pb-mobile-nav">
        ...
        <Link href="/bus" className="mt-4 inline-block text-accent hover:underline">Back to buses</Link>
      </div>
    );
  }
  ...
  return (
    <div className="pb-mobile-nav">
      ...
      <div className="container pt-6 pb-8">
        {/* Breadcrumb */}
        <Link href="/bus" className="inline-flex items-center gap-1 text-label text-muted-foreground hover:text-foreground transition-colors mb-4">
