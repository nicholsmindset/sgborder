    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "smooth-tint": "hsl(var(--status-smooth-tint))",
          moderate: "hsl(var(--status-moderate))",
          "moderate-tint": "hsl(var(--status-moderate-tint))",
          heavy: "hsl(var(--status-heavy))",
          "heavy-tint": "hsl(var(--status-heavy-tint))",
          jammed: "hsl(var(--status-jammed))",
          "jammed-tint": "hsl(var(--status-jammed-tint))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
